...
var ImageLightboxCarousel = function () {
  ...
  _createClass(ImageLightboxCarousel, [{
    ...
    key: 'lightboxImageTitle',
    value: function lightboxImageTitle() {
      // add title
      var currentLightboxImageTitleSpan = _DOMUtils.dom.createElement('h1');
    ...
    value: function render() {
      ...
      if (this.images.length) {
        if (this.openImageId) {
          var lightboxImgNavWrapperDiv = _DOMUtils.dom.createElement('div');
